...
| `study-battle-report/**` | **OCR text-processing tests**: `uv run pytest study-battle-report/test_ocr_battle_log.py -v`. Also validate representative output with `uv run python study-battle-report/ocr_battle_log.py [<batch-id>] --use-cache`. |
