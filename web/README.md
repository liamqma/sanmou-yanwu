...
dependency installation or repository web scripts run. Its logs and job summary
report only aggregate counts: newly validated and cumulative validated events,
D1 size, rows older than 14 days, rows deleted, and any remaining backlog. No
raw row or ID is printed or uploaded.
